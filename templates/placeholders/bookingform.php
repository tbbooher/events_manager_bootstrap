				...
				<?php if( $can_book ): ?>
					<div class='em-booking-form-details'>
						...
						<div class="em-booking-buttons">
							...
							<input type="image" src="<?php echo get_option('dbem_bookings_submit_button'); ?>" class="btn btn-primary" id="em-booking-submit" />
							<?php else: //Display normal submit button ?>
							<input type="submit" class="btn btn-primary" id="em-booking-submit" value="<?php echo esc_attr(get_option('dbem_bookings_submit_button')); ?>" />
							<?php endif; ?>
						</div>
